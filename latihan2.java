...
public class latihan2{
	...
	System.out.print("Input your username[5...10] :");
	name = sc.nextLine();
	...
	do{
		...
		if(choose == 1){
			...
			if(vCake.size() == 0){
				...
				do{
					System.out.print("Choose cake you want to update : ");
					cake = sc.nextLine();
				...
				System.out.println("Press to be continue");
				sc.nextLine();
			...
			if(vCake.size() == 0){
				...
				vCake.remove(cake);
				vQuantity.remove(quantity);
				vPrice.remove(price);
				vTopping.remove(topping);
			}
